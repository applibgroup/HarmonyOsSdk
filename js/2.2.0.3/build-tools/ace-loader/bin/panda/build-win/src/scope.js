...
exports.LocalScope = exports.FunctionScope = exports.ModuleScope = exports.GlobalScope = exports.VariableScope = exports.Scope = exports.FunctionParameter = exports.CatchParameter = exports.ClassDecl = exports.FuncDecl = exports.ModDecl = exports.ConstDecl = exports.LetDecl = exports.VarDecl = exports.Decl = exports.InitStatus = void 0;
...
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.find = function (name) {
        ...
        while (curScope) {
            ...
            if (!(curScope instanceof LocalScope)) {
                curLevel++;
            }
    ...
    Scope.prototype.hasDecl = function (decl) {
        return this.decls.includes(decl);
    };
...
var VariableScope = /** @class */ (function (_super) {
    ...
    VariableScope.prototype.hasLexEnv = function () {
...
var LocalScope = /** @class */ (function (_super) {
    ...
    LocalScope.prototype.setLexVar = function (v, srcScope) {
        var variableScope = this.getNearestVariableScope();
    ...
    LocalScope.prototype.add = function (name, declKind, status) {
        ...
        if (declKind == variable_1.VarDeclarationKind.NONE) {
            ...
            if (root instanceof GlobalScope || root instanceof ModuleScope) {
                ...
                log_1.LOGE(undefined, "Error: this scope'root is not globalscope, it is wrong");
                return undefined;
            }
        }

...
interface ListElement extends Element {
   ...
   */
  scrollBy(data: ScrollByValue): void;
 ...
 */
interface DialogElement extends Element {
  /**
   * Shows a dialog box.
   */
  show(): void;
 ...
 */
interface ImageAnimatorElement extends Element {
  /**
 ...
 */
interface PickerElement extends Element {
  /**
   * Displays the picker.
   */
  show(): void;

...
declare class AbilityController {
    constructor();
    startAbility(value: Want);
    performBackPress();
    getStackCount();
}
declare class AbilityComponentExtend<T> extends AbilityComponentAttribute<T> {
}
...
declare const AbilityComponent: AbilityComponent;
